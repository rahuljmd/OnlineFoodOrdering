...
<html>
    <head>
        ...
        <script>
            function go() {
                ...
                var url = "./CustomerLogin?email="+email+"&password="+pass;
    ...
    <body>
        ...
        <div class="container">
            <h1 class="jumbotron text-center" style="background-color: #007bff ; color:white;">Customer Login</h1>
            <form>
              ...
              <br>
            <a href="CustomerSignUp.jsp" style="color: blue;">Signup Now</a>&nbsp;&nbsp;
            <a href="ForgotPasswordCust.jsp" style="color: red;">Forgot Password</a>
