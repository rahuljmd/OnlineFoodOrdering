...
<html>
            ...
            function go() {
                ...
                if (email != "" && old_pass != "" && new_pass != ""&&confirm_pass!="") {
                    if (confirm_pass != new_pass) {
                        ...
                        var url = "./RestaurantChangePassword?email=" +email+"&old_pass="+old_pass+"&new_pass="+new_pass;
    ...
    <body>
        ...
        <div class="container">
            ...
            <h1 class="jumbotron text-center" style="background-color: green; color: white; margin-top: 0px;" >Restaurant Change Password</h1>
            <form>
