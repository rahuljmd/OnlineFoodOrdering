...
public class ForgotPassRest extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
       ...
       try{
         ...
         if(rs.next()){
             ...
             String msg="";
             msg+="<a href=\"http://localhost:8084/FoodOrdering/RecoverRestPass.jsp?email="+email+"\" >Click here to recover password</a>";
